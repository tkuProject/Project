...
<template>
    ...
    <div class="filter">
        <button @click="collectionOnlyActivated = !collectionOnlyActivated" :class="{activated: collectionOnlyActivated}" class="filterType collectionOnly" title="在此畫面只顯示收藏卡片的通知">收藏</button>
        <button @click="cardFilterActivated = !cardFilterActivated" :class="{activated: cardFilterActivated}" class="filterType cardFilter" title="在此畫面只顯示勾選卡片的通知">篩選</button>
        <template v-if="cardFilterActivated">
            <ul class="filterCards scrollBox">
                <li v-for="card in notiOnCards">
                    <label>
